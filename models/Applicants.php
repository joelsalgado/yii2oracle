...
class Applicants extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id', 'lada_celphone', 'celphone', 'lada_phone', 'phone', 'birh_entity_id', 'civil_status_id', 'nationality_id', 'created_at', 'updated_at'], 'integer', 'message' => 'Sólo se aceptan numeros'],
            [['date'],'date', 'format'=>'dd/mm/yyyy', 'message' => 'Formato no valido'],
            [['name', 'last_name', 'last_name2', 'CURP', 'gender'], 'string', 'max' => 255],
